...
about:Label("TH脚本")
about:Label("作者QQ：2081954141")
about:Label("QQ群：815883059")
about:Label("作者：TH")
about:Label("进群发最新TH脚本")
about:Label("脚本持续更新中")
about:Label("帮助者:su，小依")
about:Label("")
about:Label("付费脚本")
about:Label("欢迎使用TH脚本")

local UITab355 = win:Tab("『ohio』",'16060333448')

local about = UITab355:section("『TH』",true)
...
about:Toggle("残血跑路","Toggle",false,function(Value)
paolu1 = Value
        if paolu1 then
            paolu2()
        end
...
local about = UITab66:section("『TH』",true)
...
local about = UITab3565:section("『TH』",true)
...
Bank2 = function()
    ...
    local Bank = game:GetService('Workspace').BankRobbery.BankCash.Cash:FindFirstChild('Bundle')
        if Bank then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="银行已刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
Gem2 = function()
    ...
    local Ge = game:GetService('Workspace').GemRobbery:FindFirstChild('Rubble')
        if Ge then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="珠宝店已刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
local about = UITab9955:section("『TH』",true)
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="金保险未刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
AutoSafe4 = function()
    while AutoSafe3 do
        ...
        if not foundModel then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="黑保险未刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
SmallChest2 = function()
    ...
    local SmallChes = game:GetService('Workspace').Game.Entities.SmallChest
        ...
        if not foundModel then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="小宝箱未刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
LargeChest2 = function()
    ...
    local LargeChes = game:GetService('Workspace').Game.Entities.LargeChest
        ...
        if not foundModel then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="大宝箱未刷新"; Duration = 5; })
            wait(30)
        end
    end
end
...
local about = UITab4555:section("『TH』",true)
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="暂时未刷新宝藏"; Duration = 5; })
    end
end
...
SmallSafe2 = function()
    ...
    local SmallSaf = game:GetService('Workspace').Game.Entities.SmallSafe
        ...
        if not foundModel then
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『TH』"; Text ="小保险未刷新"; Duration = 5; })
            wait(35)
        end
    end
end
...
local about = UITab35665:section("『TH』",true)
...
about:Button("TH印钞机（自动更换服务器）",function()
for a=1,1 do
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『刷新中 TH』"; Text ="请等待 TH"; Duration = 2; })
...
about:Button("TH找印钞机（不能跳服务器）", function()
for a=1,30 do
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『刷新中 TH』"; Text ="请等待 TH"; Duration = 2; })
Players = game:GetService("Players")
LocalPlayer = Players.LocalPlayer
...
local about = UITab35785:section("『TH』",true)
